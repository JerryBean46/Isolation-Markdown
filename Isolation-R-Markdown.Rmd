...
```{r, echo=TRUE}
plot(mod1, type='infotrace', which.item = c(1,2,3,4,5), facet_items=T, as.table = TRUE,
...
Item information can be summed to form a test (scale) information function where higher values indicate a stronger 
relationship between the scale and the latent trait. Conditional standard errors are measures of the 
